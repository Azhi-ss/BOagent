...
class ContinuousSearchSpace(SearchSpace):
    ...
    def get_unobserved(self, observed_configs: pd.DataFrame) -> pd.DataFrame:
        """Sample the continuous space using LHS, excluding points too close to observed."""
        ...
        # In continuous space, "unobserved" usually means just the sample pool,
        # but we could filter out points extremely close to observed if needed.
        return pool_df
