...
def _get_reasoning_content(message_or_delta: Any) -> Optional[str]:
    """Relay / chat models may not expose reasoning_content."""
    return getattr(message_or_delta, "reasoning_content", None) or None
...
class DeepSeekClient:
    ...
    def multi_round_generate(
        ...
        self.reasoning_content = _get_reasoning_content(message) or ""
